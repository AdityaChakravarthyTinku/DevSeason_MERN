...
import { runCode,submitSolution } from '../api';
...
const ProblemLayout = () => {
    ...
    if (!problem) return ( <div className="in-h-screen bg-gradient-to-r from-purple-400 to-pink-400 py-12 px-4">
        <div className="bg-white shadow-md rounded-lg px-8 py-6 space-y-4">
            <div className="flex justify-between items-center mb-4">
                <h1 className='text-xl align-middle'><b>
                No Such Problem 😄 Please Explore Other Problems
                </b></h1>;
            </div>
        </div>
    </div>
            ...
            <div className="bg-white shadow-md rounded-lg px-8 py-6 space-y-4">
                <div className="flex justify-between items-center mb-4">
                    ...
                    {problem.tutorialLink && (
                        <a href={problem.tutorialLink} target="_blank"><FortBulb/></a>
